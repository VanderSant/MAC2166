...
int main()
{
    ...
    int Npalpites;  // contador de palpites(n�mero de palpites)
    ...
    while((Npalpites !=0)&&(pinos!=k)){  // o looping s� deve terminar quando os palpites acabarem ou a senha for acertada, ou seja, os pinos pretos for igual ao numero de digitos da senha
    ...
    do{
        ...
        if(a==b){
            ...
            Cpalpite=Cpalpite/10;
            Csenha=Csenha/10;}
        }while((a>0)||(b>0));  //enquanto o numero n�o for totalmente descascado o loopin ir� continuar.
    pinos= pinos-1;
    printf("%d pretos \n", pinos);
